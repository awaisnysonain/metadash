...
export default function ReportsView({ comments, teamMembers, campaigns, onNavigateToInbox }: ReportsViewProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in" id="reports-screen">
      <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <div key={s.label} className="bg-white border border-slate-200 p-4 rounded-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-5 bg-white border border-slate-200 p-5 rounded-2xl">
            ...
            {campaignVolume.length === 0 ? (
              ...
              campaignVolume.map((c, i) => (
                <button
                  ...
                  className="w-full p-3 bg-slate-50 hover:bg-blue-50 rounded-xl flex items-center justify-between transition-colors text-left"
                >
            ...
            {highPriority.length === 0 ? (
              ...
              highPriority.map(c => (
                <button
                  ...
                  className="w-full p-3 bg-white rounded-xl text-left hover:shadow-sm transition-shadow"
                >
