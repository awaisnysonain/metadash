...
export default function ProfileView() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Your Profile</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage how you appear to your team</p>
      </div>
      ...
      <form onSubmit={handleSave} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="absolute -bottom-10 left-6">
            <div className="relative group">
              {avatarUrl ? (
                ...
                <div className="w-20 h-20 rounded-2xl bg-white dark:bg-slate-900 border-4 border-white shadow-lg flex items-center justify-center text-2xl font-bold text-blue-600">
                  {initials}
                </div>
              )}
              <button
        ...
        <div className="pt-14 px-6 pb-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <div>
              <label className="text-sm font-medium text-slate-700 dark:text-slate-200 flex items-center gap-1.5 mb-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              />
            </div>
            <div>
              <label className="text-sm font-medium text-slate-700 dark:text-slate-200 flex items-center gap-1.5 mb-1.5">
            ...
            <div className="sm:col-span-2 xl:col-span-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 border border-slate-200 dark:border-slate-800 rounded-xl text-sm resize-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              />
            </div>
          </div>
